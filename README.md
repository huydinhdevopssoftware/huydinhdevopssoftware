...
<img src="https://github-maps.com/cube/huydinhdevopssoftware" alt="GitHub Cube" width="300" />
...
### 💻 Về tôi
- 🔭 **Dự án hiện tại:** Đang tập trung phát triển các hệ thống kiến trúc backend bằng **.NET / NestJS** và hoàn thiện các tựa game **2D trên Mobile**.
- 🌱 **Kỹ năng & Công nghệ:** `.NET 8/10`, `NestJS`, `React`, `Unity (2D Game Dev)`, `SQL Server`, `Prisma`.
